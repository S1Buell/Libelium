...
{
    //teste0 =receivePacket.receivePacketAO0.receivedData[0];
...
{
    int16_t size=sizeParam + 4; // Adiciona quatro devido aos campos Frame Type (0x08), FrameID e data
	tamanhoCommand=0;
...
{	
    ...
    for (uint8_t i=0;i<=MAX_RETRIES;i++)
    {
		...
		{			
            ...
            unsigned long r=(unsigned long)rand()%400LU + 100LU;
